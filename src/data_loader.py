...
DATAS_CONFIG = "./chinese-poetry/loader/datas.json" # path to poem data
...
class PlainDataLoader():
    ...
    def extract_full_poem(self, target: str) -> list:
        if target not in self.datasets:
            print(f"{target} is not included in datas.json as a dataset")
            return None
        configs = self.datasets[target]
...
if __name__ == "__main__":
    ...
    print(
        loader.extract_full_poem("songci")
    )
    # print(
